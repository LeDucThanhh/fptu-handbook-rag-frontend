      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              Hành trình học tập đầy cảm hứng và cơ hội phát triển không giới hạn
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8, delay: 0.2 }}
          >
            {Object.entries(handbookSections).map(([categoryName, sections], categoryIndex) => (
              <motion.div
                key={categoryName}
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
                  ...
                  {sections.map((section, sectionIndex) => {
                    ...
                    return (
                      <motion.div
                        ...
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.5, delay: (categoryIndex * 0.2) + (sectionIndex * 0.1) }}
                      >
                        <Link
                          to={section.path}
                          ...
                          >
                            <div className="flex h-full">
                              ...
                              <div className="w-48 h-full flex-shrink-0 relative overflow-hidden">
                                ...
                                />
                                <div className={`absolute inset-0 bg-gradient-to-br ${section.color} opacity-20 group-hover:opacity-30 transition-opacity duration-300`}></div>
                              </div>
